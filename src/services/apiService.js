import errorHandler, { NetworkError, ApiError, BoundaryChecks } from '../utils/errorHandler'
...
export const memoryApi = {
  ...
  async getAllMemories() {
    ...
    const memoryPromises = folders.map(folder => this.getMemoryDetail(folder))
  ...
  async getMemoryImages(folderName) {
    try {
      const memoryImages = await import('../../public/data/memoryImages.json')
